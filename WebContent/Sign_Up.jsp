...
<body>
 <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    ...
    <div style="padding-top: 70px;" id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
  ...
  <div class="form-group">
    ...
    <input type="date" id="start" name="date" value="1992-01-07">
  </div>
